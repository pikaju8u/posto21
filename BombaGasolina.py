...
from BombaDiesel import BombaDiesel  # Importação da nova classe BombaDiesel
...
def exibir_menu():
    ...
    print("7 - Abastecer Diesel por Valor")  # Opção para diesel por valor
    print("8 - Abastecer Diesel por Litro")  # Opção para diesel por litro
    print("9 - Sair")

def main():
    bomba1 = BombaEtanol(valor_litro=3, quantidade_disponivel=1000)
    bomba2 = BombaGasolina(valor_litro=4, quantidade_disponivel=1000)
    bomba3 = BombaDiesel(valor_litro=3.5, quantidade_disponivel=1000)  # Instância da bomba de diesel
    ...
    while True:
        ...
        if opcao == '1':
            ...
            if litros <= 0:
                ...
                print(f"Abastecido {litros:.2f} litros de diesel.")
